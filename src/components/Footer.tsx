      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
          <div className="col-span-2 lg:col-span-1">
            <div className="mb-6">
              <span className="font-heading font-bold text-2xl bg-gradient-to-r from-indigo-400 to-purple-400 bg-clip-text text-transparent">
                StudySync
              </span>
            </div>
            <p className="text-gray-400 mb-6">
              AI-powered study group matching for modern students. Find your perfect study partners and achieve your academic goals.
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <p className="text-gray-400 text-sm text-center">
            &copy; {new Date().getFullYear()} StudySync Inc. All rights reserved.
          </p>
        </div>
      </div>
    </footer>

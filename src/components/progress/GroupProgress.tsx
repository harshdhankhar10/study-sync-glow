...
const mockGroupProgress = [
  { month: 'Jan', groupAvg: 65, yourProgress: 60, classAvg: 55 },
  { month: 'Feb', groupAvg: 68, yourProgress: 65, classAvg: 58 },
  { month: 'Mar', groupAvg: 75, yourProgress: 72, classAvg: 62 },
  { month: 'Apr', groupAvg: 80, yourProgress: 78, classAvg: 67 },
  { month: 'May', groupAvg: 85, yourProgress: 82, classAvg: 70 },
  { month: 'Jun', groupAvg: 90, yourProgress: 88, classAvg: 75 },
];
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="md:col-span-2">
          ...
          <CardContent className="h-80">
            ...
            >
              <LineChart data={mockGroupProgress}>
          ...
          <CardContent className="h-80">
            <ChartContainer config={{}}>
              <PieChart>
                ...
                >
                  {mockCollaborationData.map((entry, index) => (
